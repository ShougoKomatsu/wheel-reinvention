================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: SAutomation プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した SAutomation には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには SAutomation アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
SAutomation.h
   ...
   CSAutomationApp アプリケーション クラスを宣言します。

SAutomation.cpp
   これは、アプリケーション クラス CSAutomationApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\SAutomation.ico
   ...
   アイコンはメイン リソース ファイル SAutomation.rc に含まれていま
   す。
...
SAutomationDlg.h, SAutomationDlg.cpp - ダイアログ
   これらのファイルは CSAutomationDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な SAutomation.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   SAutomation.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
